...
class CounterOfferPage extends StatefulWidget {
  ...
  const CounterOfferPage(this.transactionData, this.transactionReference, this.notificationReference);
  @override
  State<CounterOfferPage> createState() => CounterOfferPageState(this.transactionData, this.transactionReference, this.notificationReference);
}
...
class CounterOfferPageState extends State<CounterOfferPage> {
  ...
  final String transactionReference;
  final String notificationReference;
  CounterOfferPageState(this.transactionData, this.transactionReference, this.notificationReference);
  ...
  counterAccepted() async {
    ...
    sendNotification(transactionData['transaction_ID'], 
      transactionData['buyer'] + " has chosen to accept purchase with credits. Please choose a meet-up date", 
      transactionData['buyer'] + " has chosen to accept the counter offer for " + transactionData['forSale']['Title'] + ". Please select a meet-up date, time, and location that works for you" , 
    ...
    message: transactionData['buyer'] + " has chosen to accept the counter offer for " + transactionData['forSale']['Title'] + ". Please got to the app to select a meet-up time" ,  
  ...
  counterRejected() async {
    ...
    final transaction_document = FirebaseFirestore.instance.collection('transactions').doc(transactionReference);
      transaction_document.update({'status': "canceled", });
    print("transactions updated");
    ...
    sendNotification(transactionData['transaction_ID'], 
      ...
      transactionData['buyer'] + " has chosen to not accept the counter offer for " + transactionData['forSale']['Title'] + ". Your book will return to being listed for sale" , 
      transactionData['seller_email'], 
      transactionData['buyer_email']);
    print("new notification uploaded");
    ...
    await emailNotification(
    header: "Update for transaction " + transactionData['transaction_ID'].toString() , 
    message: transactionData['buyer'] + " has chosen to not accept the counter offer for " + transactionData['forSale']['Title'] + ". Your book will return to being listed for sale" ,  
    sender_name: transactionData['buyer'], 
    receiver_name: transactionData['seller'], 
    receiver_email: transactionData['seller_email']);
    print("email sent");
                  ...
                  child: Column(
                    children: [
                      Align(
                        ...
                        child: Text("Seller: " + transactionData['seller'],
                    ...
                    ElevatedButton(
                        ...
                        child: Text('Accept Counter Offer',
